...
if [ "$formfactor" == 1 ] || [ "$formfactor" == 2 ] || [ "$formfactor" == 3 ]; then
    # Core XFCE packages
    sudo pacman -S xfce4 xfce4-goodies xlibre xorg-xinit xclip xdg-desktop-portal xdg-desktop-portal-gtk pipewire pipewire-pulse pipewire-jack pipewire-alsa wireplumber lightdm-openrc lightdm lightdm-gtk-greeter fastfetch htop neovim firefox thunar thunar-volman networkmanager-applet --needed --noconfirm
